...
> ## Fix This Query
>
> Suppose we want to select all sites that lie more than a magnitude of
> 48 degrees from the poles.
> Our first query is:
>
> ~~~
...
> > will return all values that are greater than 48.
> >
...
> > {: .sql}
> >
> > ![SQL Filtering with And](../fig/sql-filter-and.svg)
> >
> {: .solution}
{: .challenge}
